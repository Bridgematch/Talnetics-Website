      ...
      <div className="container-fluid mx-auto px-4 flex flex-col lg:flex-row items-center">
        <div className="lg:w-1/2 mb-8 lg:mb-0 lg:pr-8 w-[100%] md:ml-16    ">
          <h2 className="text-4xl font-extrabold text-gray-900 mb-4">
            <span className="text-[#E55607]">BridgeMatch</span> Live Show
          </h2>
          <p className="text-lg text-gray-700 mb-6 md:pr-20">
            BridgeMatch hosts a live show where we feature various talents from different categories in the entertainment and art space. In our studio, we conduct interview sessions with talents to promote them and help them gain visibility.
          </p>
        ...
        <div className="lg:w-1/2 grid grid-cols-2 gap-4 ">
          {liveShowImages.map((src, index) => (
            <div key={index} className="overflow-hidden rounded-lg bg-black">
              <Image
                src={src}
                alt={`BridgeMatch Live Show ${index + 1}`}
                layout="responsive"
                width={400}
                height={400}
                objectFit="cover"
