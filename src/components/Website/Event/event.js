    ...
    <div className="container-fluid mx-auto px-4 flex flex-col lg:flex-row justify-center items-center">
      <div className="lg:w-1/4 mb-8 lg:mb-0 lg:pr-16 text-center lg:text-left  ">
        ...
        <p className="text-lg text-gray-700 mb-6">
          Event managers can easily upload and manage their events on BridgeMatch. Streamline the event creation process and reach a wider audience with our user-friendly interface.
        </p>
      ...
      <div className="lg:w-1/4 text-center lg:text-right">
        ...
        <p className="text-lg text-gray-700 mb-6">
          Talents can register and participate in various events listed on BridgeMatch. Showcase your skills and gain visibility by joining exciting events in your field.
        </p>
